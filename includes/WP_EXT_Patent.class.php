...
class WP_EXT_Patent {
	...
	public function __construct() {
		// Settings.
		$this->pt_ID      = 'patent';
		$this->archive_ID = 'patents';
		$this->domain_ID  = 'patent';
		$this->cap_type   = [ 'pt_patent', 'pt_patents' ];
 ...
 *
 * @return WP_EXT_Patent
 */
function WP_EXT_Patent() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Patent;
	}
 ...
 */
add_action( 'plugins_loaded', [ WP_EXT_Patent(), 'run' ] );
