...
/**
 * Class WP_EXT_Patent_ShortCode
 */
class WP_EXT_Patent_ShortCode extends WP_EXT_Patent {
 ...
 *
 * @return WP_EXT_Patent_ShortCode
 */
function WP_EXT_Patent_ShortCode() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Patent_ShortCode;
	}
 ...
 */
add_action( 'plugins_loaded', [ WP_EXT_Patent_ShortCode(), 'run' ] );
