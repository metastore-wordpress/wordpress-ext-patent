...
/**
 * Class WP_EXT_Patent_Post_Type
 */
class WP_EXT_Patent_Post_Type extends WP_EXT_Patent {
	...
	public function post_type() {
		$labels       = [
			'name'                  => _x( 'Патенты', 'Patent General Name', 'wp-ext-' . $this->domain_ID ),
			'singular_name'         => _x( 'Патент', 'Patent Singular Name', 'wp-ext-' . $this->domain_ID ),
			'menu_name'             => __( 'Патенты', 'wp-ext-' . $this->domain_ID ),
			'name_admin_bar'        => __( 'Патент', 'wp-ext-' . $this->domain_ID ),
		...
		$args         = [
			'label'               => __( 'Патент', 'wp-ext-' . $this->domain_ID ),
			'description'         => __( 'Patent Description', 'wp-ext-' . $this->domain_ID ),
			'labels'              => $labels,
 ...
 *
 * @return WP_EXT_Patent_Post_Type
 */
function WP_EXT_Patent_Post_Type() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Patent_Post_Type;
	}
 ...
 */
add_action( 'plugins_loaded', [ WP_EXT_Patent_Post_Type(), 'run' ] );
