...
/**
 * Class WP_EXT_Patent_Theme
 */
class WP_EXT_Patent_Theme extends WP_EXT_Patent {
 ...
 *
 * @return WP_EXT_Patent_Theme
 */
function WP_EXT_Patent_Theme() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Patent_Theme;
	}
 ...
 */
add_action( 'plugins_loaded', [ WP_EXT_Patent_Theme(), 'run' ] );
