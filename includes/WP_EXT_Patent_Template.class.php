...
/**
 * Class WP_EXT_Patent_Template
 */
class WP_EXT_Patent_Template extends WP_EXT_Patent {
 ...
 *
 * @return WP_EXT_Patent_Template
 */
function WP_EXT_Patent_Template() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Patent_Template;
	}
 ...
 */
add_action( 'plugins_loaded', [ WP_EXT_Patent_Template(), 'run' ] );
